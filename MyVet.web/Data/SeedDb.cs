...
namespace MyVet.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("1010", "santiago", "murillo", "santimv2907@gmail.com", "3217543188", "Calle Luna Calle Sol", "Admin");
            var customer = await CheckUserAsync("2020", "santiago", "murillo", "santimv2907@outlook.com", "3217543188", "Calle Luna Calle Sol", "Customer");
